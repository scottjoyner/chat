...
These tests protect startup safety and prevent silent misconfiguration in production-sensitive paths (live/canary modes, approvals, queue model selection).
